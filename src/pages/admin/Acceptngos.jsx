...
function Acceptngos(){
    ...
    activeTab === "All"
      ...
      : ngos.filter((ngo) => {
          ...
          if (activeTab === "Verified") return status === "ACCEPTED"; // Map "Verified" tab to "ACCEPTED" status
    ...
    switch (safeStatus) {
      ...
      case "ACCEPTED": // This matches your "ACCEPTED" status
        return {
                  ...
                  <div className="h-40 bg-gray-50 w-full relative flex items-center justify-center border-b border-gray-100">
                    {u.image ? (
                        ...
                        <div className="flex flex-col items-center text-gray-400">
                            ...
                            <span className="text-xs font-medium mt-2 uppercase tracking-widest">NGO Profile</span>
                        </div>
                    )}
                  </div>
